...
# start game and turn button into restart
def press_start():
...
# choose new target state for user to locate
...
# restart game and reset game variables
def restart_game():
...
# get state name at clicked point
...
# highlight state if click is correct
