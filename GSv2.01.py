...
label = tk.Label(window,
                 ...
                 bg="#4E59FC",                 # background color
                 highlightbackground="#ca0101",# highlight border color
...
# set up entry box
myEntry = tk.Entry(window, font=("Cambria", 10), relief="sunken", bd=3)
...
# set up exit button
button = tk.Button(window, text="EXIT", font=("Cambria", 10, "bold" ), bg="#4E59FC", fg="#FFFFFF")
button.pack(pady=5)
